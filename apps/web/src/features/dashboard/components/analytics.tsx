    ...
    <div className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>本周点击量与独立访客趋势</CardDescription>
        </CardHeader>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">较上周增长 12.4%</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">较上周增长 5.8%</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">较上周下降 3.2%</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">较上周增加 18 秒</p>
          </CardContent>
        </Card>
      </div>
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-7">
        <Card className="col-span-1 lg:col-span-4">
          <CardHeader>
            ...
            <CardDescription>带来访问量最多的来源渠道</CardDescription>
          </CardHeader>
          <CardContent>
            <SimpleBarList
              items={[
        ...
        <Card className="col-span-1 lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>用户访问应用所使用的设备类型</CardDescription>
          </CardHeader>
          <CardContent>
            <SimpleBarList
              items={[
