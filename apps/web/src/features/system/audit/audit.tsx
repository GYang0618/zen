...
import { ConfigDrawer, ProfileDropdown, Search as GlobalSearch, ThemeSwitch } from '@/components'
import { Header, Main } from '@/components/layouts'
import { EmptyState, SystemPageHeader } from '@/features/system/components'

import { useAuditList, useLoginEvents } from './queries'
  ...
  return (
    <>
      ...
      <Main className="flex flex-1 flex-col gap-4 sm:gap-6">
        <SystemPageHeader title="操作审计" description="查询写操作审计与登录历史，便于安全追溯" />
        ...
        >
          ...
          <TabsContent value="ops" className="flex flex-col gap-4">
            ...
            <AuditListCard
              ...
              emptyTitle="暂无操作记录"
              emptyDescription={applied ? '换个关键词试试，或清除筛选后重试' : '系统写操作会在此聚合展示'}
              page={page}
