...
import { ButtonGroup, ButtonGroupText } from '@zen/ui/components/button-group'
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      'is-user:dark flex w-fit min-w-0 max-w-full flex-col gap-6 overflow-hidden text-sm',
